...
<footer class="footer">
    <div class="footer-content">
        <div class="footer-flex">
            ...
            <div class="footer-section">
                ...
                <div class="footer-contact">
                    <p><i class="fas fa-map-marker-alt"></i> 123 Railway Street, Chittorgarh, India</p>
                    <p><i class="fas fa-phone"></i>+91 8454545454</p>
        ...
        <div class="footer-bottom">
            <p>© 2026 RailBooker - Railway Ticket Booking System. All Rights Reserved.</p>
